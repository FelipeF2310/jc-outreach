...
## Retention update 013 — prepared, not applied

This is a **two-step** handoff. Neither step has been performed against the owner's hosted database by this implementation turn. Applied migrations 002–012 remain immutable. Do not initialize/reset the database, move existing campaign deadlines or delete practice records to make a test pass.
