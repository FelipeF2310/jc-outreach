...
1. Build event/assignment preparation on the confirmed synthetic campaign/import foundation. Capture remaining hosted negative/retry evidence separately rather than implying the owner's happy-path test closes every import gate.
