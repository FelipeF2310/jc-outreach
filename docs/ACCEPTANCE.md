...
- [ ] R01: Scheduled deletion removes all application-controlled identifying campaign records despite open help requests. Local native-PostgreSQL worker tests cover 20 populated campaign/child/history tables and preserve a future campaign. Migration 013 and schedule setup are complete. Independent READ ONLY audits observed automatic worker completions at 2026-09-17 17:14 and 17:16 UTC, with no manual invocation, three active campaigns preserved and zero deleted/overdue/failed campaigns. Actual scheduled deletion of an approved disposable expired fixture remains pending; healthy no-op runs do not close this gate.
