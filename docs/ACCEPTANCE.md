...
- [ ] R01: Scheduled deletion removes all application-controlled identifying campaign records despite open help requests. Local native-PostgreSQL worker tests cover 20 populated campaign/child/history tables and preserve a future campaign. Migration 013 and Cron are installed, independently verified with restricted-runtime/status checks at 2026-09-17 17:11:23 UTC; no worker run is recorded and actual hosted schedule activation/execution remain pending. Installation/direct worker calls are not scheduler proof.
