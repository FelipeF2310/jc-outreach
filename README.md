...
Current development slice (2026-09-17): browser-scoped walk-completion reporting is implemented. Volunteers can finish a walk locally, synchronize its status, and resume; administrators see completion only when that browser's declared records have arrived. It never creates door attempts. Hosted updates 011–012 are applied and restricted-runtime capability/status reads passed at 16:21:01 UTC. The owner walkthrough remains pending. See [setup and walkthrough](docs/HOSTED-SETUP.md#walk-completion-updates-011012--applied-and-read-verified). HTTPS hosting/phone-link tests remain deferred, not completed.
